...
CREATE TABLE public.actors (
    ...
    surname character varying(30) DEFAULT 'Depp'::character varying NOT NULL,
...
CREATE TABLE public.directors (
    id integer NOT NULL,
    name character varying(30),
    surname character varying(30) DEFAULT 'surname'::character varying NOT NULL
);
...
CREATE TABLE public.films (
    id integer NOT NULL,
    name_film character varying(30),
    genre character varying(30) DEFAULT 'film'::character varying NOT NULL
);
...
COPY public.actors (id, name, surname, films) FROM stdin;
\.
...
COPY public.films (id, name_film, genre) FROM stdin;
\.
